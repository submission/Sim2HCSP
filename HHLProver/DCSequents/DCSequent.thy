...
DA5              : " [|RI s; RI t|] ==> |- (dur (S) [=] s [^]  dur (S) [=] t) [<->] dur (S) [=] s [+] t" and
DA6              : "|- s1 [<->] s2 ==> |- dur (s1) [=] dur (s2)"

(*Part of theorems given in [Zhou&Hansen03] for DC.*)
axiomatization where
DC11     : "$H, (high WFalse) |- $H, WFalse" and
DC12    : "$H |- $E, (high ([~]s)) ==> $H |- $E, (dur (s) [=] (Real 0))" and
DC18     : "$H, s |- t ==> $H, (high s) |- (high t)" and
DCR3    : "$H |- (high S) [^] (high S),$E ==> $H |- (high S),$E" and
DCL3    : "$H, (high S)|-$E ==> $H,(high S)[^](high S) |- $E" and
DCR4    : "$H |- (high S),$E ==> $H |- (high S)[^] (high S),$E" and
DCL4    : "$H, (high S)[^](high S) |-$E ==> $H,(high S) |- $E" and

DCM     : "[|$H,(high Q),$F |- $E; $H,P,$F |- Q|] ==> $H,(high P),$F |- $E"
end
